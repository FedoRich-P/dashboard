...
export default function AdminPage() {
  return (
    <main className="p-4 flex gap-4 flex-col md:flex-row">
      <section className="w-full min-h-full lg:w-2/3 flex flex-col gap-8">
        ...
        <div className="flex gap-4 flex-col lg:flex-row">
          <CountChart className={'w-full lg:w-1/3'} boysCount={25756} girlsCount={10072} />
          <AttendanceChart className={'w-full lg:w-2/3'} />
        </div>
        <FinanceChart className={'w-full'} />
      </section>
